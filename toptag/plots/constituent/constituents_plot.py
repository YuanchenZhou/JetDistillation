...
plt.figure()
plt.hist(pythia_constituent_num, range(0, 200, 2), label='Pythia Combined', alpha=0.5)
plt.hist(pythia_qcd_constituent_num, range(0, 200, 2), label='Pythia QCD', alpha=0.5)
plt.hist(pythia_top_constituent_num, range(0, 200, 2), label='Pythia Top Quark', alpha=0.5)
...
plt.figure()
plt.hist(herwig_constituent_num, range(0, 200, 2), label='Herwig Combined', alpha=0.5)
plt.hist(herwig_qcd_constituent_num, range(0, 200, 2), label='Herwig QCD', alpha=0.5)
plt.hist(herwig_top_constituent_num, range(0, 200, 2), label='Herwig Top Quark', alpha=0.5)
plt.ylabel('Number of jets')
plt.xlabel('Number of Particles')
