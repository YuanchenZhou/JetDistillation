...
if(args.doEarlyStopping):
    ...
    '''
    mc_d = ModelCheckpoint(filepath = f'/users/yzhou276/work/toptag/student/dnn/avg_model/pythia_student_{dense_sizes}_dnn_by_{len(pythia_teachers)}pythia_{len(herwig_teachers)}herwig_pfn_teachers.keras',
                           ...
                           save_format="tf")
    '''
    mc_d = CustomModelCheckpoint(filepath = f'/users/yzhou276/work/toptag/student/dnn/avg_model/pythia_student_{dense_sizes}_dnn_by_{len(pythia_teachers)}pythia_{len(herwig_teachers)}herwig_pfn_teachers.keras',
                                 monitor='val_categorical_crossentropy',
                                 mode='auto',
                                 verbose=1,
                                 save_best_only=True,
    ...
    #dnn_pythia_student.save(f'/users/yzhou276/work/toptag/student/dnn/avg_model/pythia_student_{dense_sizes}_dnn_by_{len(pythia_teachers)}pythia_{len(herwig_teachers)}herwig_pfn_teachers.keras')
...
if(args.doEarlyStopping):
    ...
    es_d = EarlyStopping(monitor='val_categorical_crossentropy', mode='auto', verbose=1, patience=args.patience)
    '''
    mc_d = ModelCheckpoint(filepath = f'/users/yzhou276/work/toptag/student/dnn/avg_model/herwig_student_{dense_sizes}_dnn_by_{len(pythia_teachers)}pythia_{len(herwig_teachers)}herwig_pfn_teachers.keras',
                           monitor='val_categorical_crossentropy',
                           mode='auto',
                           verbose=1,
                           save_best_only=True,
                           save_format="tf")
    '''
    mc_d = CustomModelCheckpoint(filepath = f'/users/yzhou276/work/toptag/student/dnn/avg_model/herwig_student_{dense_sizes}_dnn_by_{len(pythia_teachers)}pythia_{len(herwig_teachers)}herwig_pfn_teachers.keras',
                                 monitor='val_categorical_crossentropy',
                                 mode='auto',
                                 verbose=1,
                                 save_best_only=True,
    ...
    #dnn_herwig_student.save(f'/users/yzhou276/work/toptag/student/dnn/avg_model/herwig_student_{dense_sizes}_dnn_by_{len(pythia_teachers)}pythia_{len(herwig_teachers)}herwig_pfn_teachers.keras')
...
with open(f'/users/yzhou276/work/toptag/student/dnn/avg_auc/best_pythia_dnn_student_nlayers{nLayers}_dense{layerSize}_by_{len(pythia_teachers)}pythia_{len(herwig_teachers)}herwig_pfn_teachers.txt', 'w') as f:
...
with open(f'/users/yzhou276/work/toptag/student/dnn/avg_auc/best_herwig_dnn_student_nlayers{nLayers}_dense{layerSize}_by_{len(pythia_teachers)}pythia_{len(herwig_teachers)}herwig_pfn_teachers.txt', 'w') as f:
