...
plt.savefig(f'/users/yzhou276/work/qgtag/simple/dnn/roc_curves/best_dnn_nlayers{nLayers}_dense{layerSize}_{model_num}_PP_ROC.jpg')
...
#plt.ylim(0, 1)
plt.legend()#loc='lower left', frameon=False)
plt.savefig(f'/users/yzhou276/work/qgtag/simple/dnn/roc_curves/best_dnn_nlayers{nLayers}_dense{layerSize}_{model_num}_PH_ROC.jpg')
...
#plt.ylim(0, 1)
plt.legend()#loc='lower left', frameon=False)
plt.savefig(f'/users/yzhou276/work/qgtag/simple/dnn/roc_curves/best_dnn_nlayers{nLayers}_dense{layerSize}_{model_num}_HH_ROC.jpg')
...
#plt.ylim(0, 1)
plt.legend()#loc='lower left', frameon=False)
plt.savefig(f'/users/yzhou276/work/qgtag/simple/dnn/roc_curves/best_dnn_nlayers{nLayers}_dense{layerSize}_{model_num}_HP_ROC.jpg')
