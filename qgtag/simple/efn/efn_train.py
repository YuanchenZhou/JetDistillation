...
if(args.doEarlyStopping):
    ...
    mc = ModelCheckpoint(filepath =f'/users/yzhou276/work/qgtag/simple/efn/model/best_{Phi_sizes_student}_{F_sizes_student}_efn_pythia.keras', monitor='val_loss', mode='min', verbose=1, save_best_only=True)
    ...
    efn_pythia_simple.fit(X_pythia_train, Y_pythia_train,
                   ...
                   validation_data=(X_pythia_val, Y_pythia_val),
                   verbose=1)
    efn_pythia_simple.save(f'/users/yzhou276/work/qgtag/simple/efn/model/best_{Phi_sizes_student}_{F_sizes_student}_efn_pythia.keras')
...
if(args.doEarlyStopping):
    es = EarlyStopping(monitor='val_loss', mode='min', verbose=1, patience=args.patience)
    mc = ModelCheckpoint(filepath =f'/users/yzhou276/work/qgtag/simple/efn/model/best_{Phi_sizes_student}_{F_sizes_student}_efn_herwig.keras', monitor='val_loss', mode='min', verbose=1, save_best_only=True)
    ...
    efn_herwig_simple.fit(X_herwig_train, Y_herwig_train,
                   ...
                   validation_data=(X_herwig_val, Y_herwig_val),
                   verbose=1)
    efn_herwig_simple.save(f'/users/yzhou276/work/qgtag/simple/efn/model/best_{Phi_sizes_student}_{F_sizes_student}_efn_herwig.keras')
...
with open(f'/users/yzhou276/work/qgtag/simple/efn/auc/best_pythia_efn_latent{args.latentSizeStudent}_phi{args.phiSizesStudent}.txt', 'w') as f:
...
with open(f'/users/yzhou276/work/qgtag/simple/efn/auc/best_herwig_efn_latent{args.latentSizeStudent}_phi{args.phiSizesStudent}.txt', 'w') as f:
