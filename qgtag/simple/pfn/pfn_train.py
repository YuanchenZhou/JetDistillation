...
plt.savefig(f'/users/yzhou276/work/qgtag/simple/pfn/roc_curves/best_pfn_latent{args.latentSize}_phi{args.phiSizes}_{model_num}_PP_ROC.jpg')
...
#plt.ylim(0, 1)
plt.legend()#loc='lower left', frameon=False)
plt.savefig(f'/users/yzhou276/work/qgtag/simple/pfn/roc_curves/best_pfn_latent{args.latentSize}_phi{args.phiSizes}_{model_num}_PH_ROC.jpg')
...
#plt.ylim(0, 1)
plt.legend()#loc='lower left', frameon=False)
plt.savefig(f'/users/yzhou276/work/qgtag/simple/pfn/roc_curves/best_pfn_latent{args.latentSize}_phi{args.phiSizes}_{model_num}_HH_ROC.jpg')
