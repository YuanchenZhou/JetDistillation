...
if(args.doEarlyStopping):
    ...
    '''
    mc_d = ModelCheckpoint(filepath = f'/users/yzhou276/work/qgtag/student/efn/model/student_{Phi_sizes_student}_{F_sizes_student}_efn_by_{Phi_sizes_teacher}_{F_sizes_teacher}_pfn_pythia.keras',
                           ...
                           save_format="tf")
    '''
    mc_d = CustomModelCheckpoint(filepath = f'/users/yzhou276/work/qgtag/student/efn/model/student_{Phi_sizes_student}_{F_sizes_student}_efn_by_{Phi_sizes_teacher}_{F_sizes_teacher}_pfn_pythia.keras',
                                 monitor='val_categorical_crossentropy',
                                 mode='auto',
                                 verbose=1,
                                 save_best_only=True,
    ...
    #efn_pythia_student.save(f'/users/yzhou276/work/qgtag/student/efn/model/student_{Phi_sizes_student}_{F_sizes_student}_efn_by_{Phi_sizes_teacher}_{F_sizes_teacher}_pfn_pythia.keras')
...
if(args.doEarlyStopping):
    ...
    es_d = EarlyStopping(monitor='val_categorical_crossentropy', mode='auto', verbose=1, patience=args.patience)
    '''
    mc_d = ModelCheckpoint(filepath = f'/users/yzhou276/work/qgtag/student/efn/model/student_{Phi_sizes_student}_{F_sizes_student}_efn_by_{Phi_sizes_teacher}_{F_sizes_teacher}_pfn_herwig.keras',
                           monitor='val_categorical_crossentropy',
                           mode='auto',
                           verbose=1,
                           save_best_only=True,
                           save_format="tf")
    '''
    mc_d = CustomModelCheckpoint(filepath = f'/users/yzhou276/work/qgtag/student/efn/model/student_{Phi_sizes_student}_{F_sizes_student}_efn_by_{Phi_sizes_teacher}_{F_sizes_teacher}_pfn_herwig.keras',
                                 monitor='val_categorical_crossentropy',
                                 mode='auto',
                                 verbose=1,
                                 save_best_only=True,
    ...
    #efn_herwig_student.save(f'/users/yzhou276/work/qgtag/student/efn/model/student_{Phi_sizes_student}_{F_sizes_student}_efn_by_{Phi_sizes_teacher}_{F_sizes_teacher}_pfn_herwig.keras')
...
with open(f'/users/yzhou276/work/qgtag/student/efn/auc/best_pythia_efn_student_latent{args.latentSizeStudent}_phi{args.phiSizesStudent}.txt', 'w') as f:
...
with open(f'/users/yzhou276/work/qgtag/student/efn/auc/best_herwig_efn_student_latent{args.latentSizeStudent}_phi{args.phiSizesStudent}.txt', 'w') as f:
