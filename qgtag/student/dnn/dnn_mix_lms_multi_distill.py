...
if(args.doEarlyStopping):
    ...
    '''
    mc_d = ModelCheckpoint(filepath = f'/users/yzhou276/work/qgtag/student/dnn/lms_model/mix_student_{dense_sizes}_dnn_by_{len(pythia_teachers)}pythia_{len(herwig_teachers)}herwig_{len(mix_teachers)}mix_pfn_teachers.keras',
                           ...
                           save_format="tf")
    '''
    mc_d = CustomModelCheckpoint(filepath = f'/users/yzhou276/work/qgtag/student/dnn/lms_model/mix_student_{dense_sizes}_dnn_by_{len(pythia_teachers)}pythia_{len(herwig_teachers)}herwig_{len(mix_teachers)}mix_pfn_teachers.keras',
                                 monitor='val_categorical_crossentropy',
                                 mode='auto',
                                 verbose=1,
                                 save_best_only=True,
    ...
    #dnn_mix_student.save(f'/users/yzhou276/work/qgtag/student/dnn/lms_model/mix_student_{dense_sizes}_dnn_by_{len(pythia_teachers)}pythia_{len(herwig_teachers)}herwig_{len(mix_teachers)}mix_pfn_teachers.keras')
...
with open(f'/users/yzhou276/work/qgtag/student/dnn/lms_auc/best_mix_dnn_student_nlayers{nLayers}_dense{layerSize}_by_{len(pythia_teachers)}pythia_{len(herwig_teachers)}herwig_{len(mix_teachers)}mix_pfn_teachers.txt', 'w') as f:
