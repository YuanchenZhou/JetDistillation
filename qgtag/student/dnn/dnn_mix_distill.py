...
if(args.doEarlyStopping):
    ...
    '''
    mc_d = ModelCheckpoint(filepath = f'/users/yzhou276/work/qgtag/student/dnn/model/student_{dense_sizes}_dnn_by_{Phi_sizes_teacher}_{F_sizes_teacher}_pfn_mix_{alpha_value}alpha_{pythia_ratio}Pythia_{herwig_ratio}Herwig_{model_num}.keras',
                           ...
                           save_format="tf")
    '''
    mc_d = CustomModelCheckpoint(filepath = f'/users/yzhou276/work/qgtag/student/dnn/model/student_{dense_sizes}_dnn_by_{Phi_sizes_teacher}_{F_sizes_teacher}_pfn_mix_{alpha_value}alpha_{pythia_ratio}Pythia_{herwig_ratio}Herwig_{model_num}.keras',
                                 monitor='val_categorical_crossentropy',
                                 mode='auto',
                                 verbose=1,
                                 save_best_only=True,
    ...
    #dnn_mix_student.save(f'/users/yzhou276/work/qgtag/student/dnn/model/student_{dense_sizes}_dnn_by_{Phi_sizes_teacher}_{F_sizes_teacher}_pfn_mix_{alpha_value}alpha_{pythia_ratio}Pythia_{herwig_ratio}Herwig_{model_num}.keras')
...
### Mix Student Pareto ###
with open(f'/users/yzhou276/work/qgtag/student/dnn/auc/best_mix_dnn_student_nlayers{nLayers}_dense{layerSize}_{alpha_value}alpha_{pythia_ratio}Pythia_{herwig_ratio}Herwig_{model_num}.txt', 'w') as f:
