...
if(args.doEarlyStopping):
    ...
    '''
    mc_d = ModelCheckpoint(filepath = f'/users/yzhou276/work/qgtag/student/dnn/lms_model/student_{dense_sizes}_dnn_by_{len(pfn_teachers)}_pfn_teachers_pythia.keras',
                           ...
                           save_format="tf")
    '''
    mc_d = CustomModelCheckpoint(filepath = f'/users/yzhou276/work/qgtag/student/dnn/lms_model/student_{dense_sizes}_dnn_by_{len(pfn_teachers)}_pfn_teachers_pythia.keras',
                                 monitor='val_categorical_crossentropy',
                                 mode='auto',
                                 verbose=1,
                                 save_best_only=True,
    ...
    #dnn_pythia_student.save(f'/users/yzhou276/work/qgtag/student/dnn/lms_model/student_{dense_sizes}_dnn_by_{len(pfn_teachers)}_pfn_teachers_pythia.keras')
...
if(args.doEarlyStopping):
    ...
    es_d = EarlyStopping(monitor='val_categorical_crossentropy', mode='auto', verbose=1, patience=args.patience)
    '''
    mc_d = ModelCheckpoint(filepath = f'/users/yzhou276/work/qgtag/student/dnn/lms_model/student_{dense_sizes}_dnn_by_{len(pfn_teachers)}_pfn_teachers_herwig.keras',
                           monitor='val_categorical_crossentropy',
                           mode='auto',
                           verbose=1,
                           save_best_only=True,
                           save_format="tf")
    '''
    mc_d = CustomModelCheckpoint(filepath = f'/users/yzhou276/work/qgtag/student/dnn/lms_model/student_{dense_sizes}_dnn_by_{len(pfn_teachers)}_pfn_teachers_herwig.keras',
                                 monitor='val_categorical_crossentropy',
                                 mode='auto',
                                 verbose=1,
                                 save_best_only=True,
    ...
    #dnn_herwig_student.save(f'/users/yzhou276/work/qgtag/student/dnn/lms_model/student_{dense_sizes}_dnn_by_{len(pfn_teachers)}_pfn_teachers_herwig.keras')
...
with open(f'/users/yzhou276/work/qgtag/student/dnn/lms_auc/best_pythia_dnn_student_nlayers{nLayers}_dense{layerSize}.txt', 'w') as f:
...
with open(f'/users/yzhou276/work/qgtag/student/dnn/lms_auc/best_herwig_dnn_student_nlayers{nLayers}_dense{layerSize}.txt', 'w') as f:
