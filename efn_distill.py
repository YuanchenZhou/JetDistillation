...
# Set up the pythia 'simple' and 'student' models, which will be energy-flow networks (EFNs)
...
if(args.doEarlyStopping):
    ...
    mc = ModelCheckpoint(filepath =f'/users/yzhou276/work/QGtag/distill_save/efn_models/simple_{Phi_sizes_student}_{F_sizes_student}_efn_by_pythia.keras', monitor='val_loss', mode='min', verbose=1, save_best_only=True)
    ...
    efn_pythia_simple.fit(X_pythia_train, Y_pythia_train,
                   ...
                   validation_data=(X_pythia_val, Y_pythia_val),
                   verbose=1)
    efn_pythia_simple.save(f'/users/yzhou276/work/QGtag/distill_save/efn_models/simple_{Phi_sizes_student}_{F_sizes_student}_efn_by_pythia.keras')
...
if(args.doEarlyStopping):
    es = EarlyStopping(monitor='val_loss', mode='min', verbose=1, patience=args.patience)
    mc = ModelCheckpoint(filepath =f'/users/yzhou276/work/QGtag/distill_save/efn_models/simple_{Phi_sizes_student}_{F_sizes_student}_efn_by_herwig.keras', monitor='val_loss', mode='min', verbose=1, save_best_only=True)
    ...
    efn_herwig_simple.fit(X_herwig_train, Y_herwig_train,
                   ...
                   validation_data=(X_herwig_val, Y_herwig_val),
                   verbose=1)
    efn_herwig_simple.save(f'/users/yzhou276/work/QGtag/distill_save/efn_models/simple_{Phi_sizes_student}_{F_sizes_student}_efn_by_herwig.keras')
############################################
